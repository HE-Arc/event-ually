...
<head>
    ...
    <title>{{ config('app.name', 'Eventually') }}</title>
    ...
    <link href="{{ asset('css/eventually.css') }}" rel="stylesheet">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link nav-text" href="{{ route('create') }}">{{ __('Créer un événement') }}</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('profile',[auth()->user()->id]) }}">{{ __('Mon profil') }}</a>
